...
Example of use: python pom2_SVM_worker_local_flask.py --id 0
...
if __name__ == "__main__":
    ...
    if FLAGS.id is None or FLAGS.id not in ['0', '1', '2', '3', '4']:
        ...
        print('Usage: python pom2_SVM_worker_local_flask.py --id <id>')
    ...
    plot_cm_seaborn(preds_tst, ytst, classes, 'SVM confusion matrix in test set worker', model_type, dataset_name, logger, verbose, normalize=False)
