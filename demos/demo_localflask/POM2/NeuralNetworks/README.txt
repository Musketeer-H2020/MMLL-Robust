...
Important notes:
    ...
    - The architecture of the Keras model to use is defined inside this folder. If you want to try a different architecture use the script model_definition_keras.py and define a new architecture using the sequential or functional API provided by Keras. This new filename should be updated at the beginning of pom2_NN_gradient_averaging_master_pycloudmessenger.py and pom2_NN_model_averaging_master_pycloudmessenger.py in order for the changes to take place.
-------------------------------------------
...
python pom2_NN_gradient_averaging_master_local_flask.py
python pom2_NN_worker_local_flask.py --id 0
python pom2_NN_worker_local_flask.py --id 1
...
==================================================================
python ../../local_flask_server.py
python pom2_NN_model_averaging_master_local_flask.py
python pom2_NN_worker_local_flask.py --id 0
python pom2_NN_worker_local_flask.py --id 1
