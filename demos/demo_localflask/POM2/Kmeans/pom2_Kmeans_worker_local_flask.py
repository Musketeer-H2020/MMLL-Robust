...
Example of use: python pom2_Kmeans_worker_local_flask.py --id 0
...
if __name__ == "__main__":
    ...
    if FLAGS.id is None or FLAGS.id not in ['0', '1', '2', '3', '4']:
        ...
        print('Usage: python pom2_Kmeans_worker_local_flask.py --dataset mnist --verbose False --id <id>')
    ...
    display('Creating WorkerNode under POM2, communicating through local flask', logger, verbose)
