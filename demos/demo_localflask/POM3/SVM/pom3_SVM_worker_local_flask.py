...
Example of use: python pom3_SVM_worker_local_flask.py --id 0
...
if __name__ == "__main__":
    ...
    parser.add_argument('--id', type=int, default=None, choices=[0, 1, 2, 3, 4], help='The addresses of the workers')
