...
python pom3_SVM_master_local_flask.py
python pom3_SVM_worker_local_flask.py --id 0
python pom3_SVM_worker_local_flask.py --id 1
...
==================================================================
python ../../local_flask_server.py
python pom3_SVM_master_local_flask.py --preprocessing std
python pom3_SVM_worker_local_flask.py --id 0
python pom3_SVM_worker_local_flask.py --id 1
