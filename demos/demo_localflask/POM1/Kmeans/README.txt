...
python pom1_Kmeans_master_local_flask.py
python pom1_Kmeans_worker_local_flask.py --id 0
python pom1_Kmeans_worker_local_flask.py --id 1
...
==================================================================
python ../../local_flask_server.py
python pom1_Kmeans_master_local_flask_minmax_normalization.py
python pom1_Kmeans_worker_local_flask_normalization.py --id 0
python pom1_Kmeans_worker_local_flask_normalization.py --id 1
...
==================================================================
python ../../local_flask_server.py
python pom1_Kmeans_master_local_flask_std_normalization.py
python pom1_Kmeans_worker_local_flask_normalization.py --id 0
python pom1_Kmeans_worker_local_flask_normalization.py --id 1
