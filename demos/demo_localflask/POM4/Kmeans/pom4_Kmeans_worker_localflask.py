...
Jan. 2020
python pom4_Kmeans_worker_localflask.py --id 0 --dataset synth2D --verbose 1
...
if __name__ == "__main__":
    ...
    display('Creating WorkerNode under POM4, communicating through localflask', logger, True)
    #########################################
    # Creating Comms object, needed by MMLL
    comms = Comms(my_id=worker_address)
    #########################################
    # Creating Workernode
    wn = WorkerNode(pom, comms, logger, verbose=verbose, master_address='ma', cryptonode_address='ca')
