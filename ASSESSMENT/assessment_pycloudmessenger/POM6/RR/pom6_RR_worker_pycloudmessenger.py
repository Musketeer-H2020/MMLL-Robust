...
if __name__ == "__main__":
    ...
    # Load the data for the workers log
    with open('./log.pkl', 'rb') as f:
        [exp_number, log_folder] = pickle.load(f)
    logger = Logger(log_folder + 'worker_' + str(worker_real_name) + '.log')
    ...
    dc = DC(data_file)
    [Xtr, ytr] = dc.get_data_train_Worker(Nworkers, int(worker_real_name))
